class Cxmsg{
    ...
    static mostrar=(config,titulo,texto)=>{
        ...
        this.comando_s_n=()=>{config.comando_s_n()}
        ...
        const estilo_areaCxmsg =
            "display: flex;" + // Adicionado o ponto e vírgula no final
            "justify-content: flex-start;" +
            "align-items: flex-start;" +
            "flex-direction: column;" + // Flex direction já está correto para empilhar os elementos
            "width: 300px;";
